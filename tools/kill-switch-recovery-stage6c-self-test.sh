...
REPORT="$REPORT_DIR/pia-kill-switch-recovery-stage6c-self-test.txt"
mkdir -p "$REPORT_DIR"
exec > >(tee "$REPORT") 2>&1

printf 'PIA Bazzite stage-6C real-GUI recovery integration self-test\n'
...
printf '\nALL STAGE-6C GUI RECOVERY INTEGRATION SELF-TESTS PASSED\n'
