...
REPORT="$REPORT_DIR/pia-kill-switch-recovery-stage6c1-self-test.txt"
mkdir -p "$REPORT_DIR"
exec > >(tee "$REPORT") 2>&1

printf 'PIA Bazzite stage-6C.1 clear security wording and GUI-sentinel gate self-test\n'
...
printf '\nALL STAGE-6C.1 GUI SENTINEL GATE SELF-TESTS PASSED\n'
