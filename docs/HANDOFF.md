...
**Current development baseline:** **0.7.0 development — Stage 1 verified; Stage 2A server-favorites core verified; Stage 2B main-window favorites UI candidate awaiting real GUI verification**
